...
public class Login {
	...
	public static boolean ValidLogin(WebDriver driver) {
		...
		try {
			...
			passowrd.sendKeys(TestData.PASSWORD);
			 ...
			 * USERNAME_XPATH)));
			 * driver.findElement(By.xpath(Locator.USERNAME_XPATH)).sendKeys(TestData.
			 * USERNAME);
			 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(Locator.
			 * PASSWORD_XPATH)));
			 * driver.findElement(By.xpath(Locator.PASSWORD_XPATH)).sendKeys(TestData.
			 * PASSWORD); //
			 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(Locator.
			 * LOGINBUTTON_XPATH)));
